...
import ProductPage from "../LandingPageComponent/ProductPage";
import ProductSubCategory from "../LandingPageComponent/ProductSubCategory";
...
function ProductDetails() {
    ...
    return (
        ...
        {/* <ul style = {{display: "flex",listStyle: "none"}}>
         ...
         <li><Link to='/productSubCategory/Rugs' element = {<ProductSubCategory/>}style={{ color: '#000000', textDecoration: 'none' }}>Sub-Categories /</Link></li>   
         <li><Link to='/productSubCategory/Rugs' element = {<ProductSubCategory/>}style={{ color: '#000000', textDecoration: 'none' }}>Products /</Link></li>
        ...
        <li><Link to='/' style={{ color: '#000000', textDecoration: 'none' }}>Home /</Link></li>
         ...
         <li><Link to='/products/*' element = {<ProductPage/>}style={{ color: '#000000', textDecoration: 'none' }}>Products /</Link></li>
         <li>Product</li>
         </ul>
