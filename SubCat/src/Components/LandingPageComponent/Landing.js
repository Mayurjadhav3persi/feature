        ...
        <div className='landing-page'>
            ...
            <Grid container spacing={4} className='product-card'>
                {categories.map(category => (
                    ...
                    <NavLink key={category.id}  to={`/productSubCategory?categoryName=${category.name}`}  style={{textTransform:'capitalize',textDecoration:'none',fontSize:'30px'}}>
                        ...
                        {/* navigationTrack = {details = { "category" : category.name }} */}
                    </NavLink>
                    </Grid>
